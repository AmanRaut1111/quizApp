...
const addQuestion = async (req, res) => {
    try {
        ...
        if (data) {
            res.status(200).json({ message: "Question is Added Sucessfully..!", status: true, statusCode: 200, data: data })
        } else {
...
const getAllQuestions = async (req, res) => {
    try {
        ...
        if (questionsData) {
            res.status(200).json({ message: "Questions Found Sucessfully...!", status: true, statusCode: 200, data: questionsData })
        } else {
            res.status(400).json({ message: "Something Went Wrong...!", status: false, statusCode: 400 })
        }
    } catch (error) {
